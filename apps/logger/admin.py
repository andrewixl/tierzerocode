...
class LogAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'event_code', 'event_type', 'event_group', 'user_level', 'privledged', 'action', 'outcome', 'additional_data', 'created_at', 'user_id')
    # Add search functionality
    search_fields = ('event_code', 'event_type', 'event_group', 'action', 'user_id')
    # Add filters
    list_filter = ('event_type', 'event_group', 'user_level', 'privledged', 'outcome', 'created_at')
    # Enable ordering
